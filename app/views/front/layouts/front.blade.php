                                ...
                                <ul class="sf-menu">
                                    ...
                                    <li @if(Request::segment(2) == 'profile' || Request::segment(2) == 'info' || Request::segment(2) == 'vision' || Request::segment(2) == 'boardofdirectors' || Request::segment(2) == 'structure')class="current-menu-item" @endif><a href="#">About CPI</a>
                                        <ul>
                                            ...
                                            <li><a href="{{ url() }}/company/qualityassurance">Quality Assurance</a>
                                            	<ul>
                                                	<li><a href="{{ url() }}/company/healthpolicy">Occupational Safety and Health Policy</a></li>
                                                    <li><a href="{{ url() }}/company/qualitypolicy">Quality Policy</a></li>
                                                    <li><a href="{{ url() }}/company/environmentalpolicy">Environmental Policy</a></li>
                                                    <li><a href="{{ url() }}/company/commandment">Commandment</a></li>
                                                </ul>
							...
							<div class="widget widget__footer">
								...
								<div class="list list-style__arrow1">
									<ul class="recent-posts-list">
                                        @foreach($about_cpi as $key => $data)
										<li>
                                            <a href="{{ $data->line1 }}">
                                                {{ html_entity_decode($data->details) }}
                                            </a>
                                        </li>
                                        @endforeach
									</ul>
						...
						<div class="grid_3">
							...
							<div class="recent-posts widget widget__footer">
								...
								<div class="widget-content">
                                    <ul class="recent-posts-list">
                                        @foreach($about_cpi as $key=>$data)
                                        <li>{{ html_entity_decode($data->details) }}</li>
                                        @endforeach
                                    </ul>
                                </div>
							</div>
                            ...
                            <div class="grid_12 mobile-nomargin">
                                <div class="clearfix">
                                    <div class="copyright-primary">
                                        {{ html_entity_decode(@$copyright[0]->details) }}
                                    </div>
                                </div>
                            </div>
