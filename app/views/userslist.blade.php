    ...
    <div class="col-lg-12">
        ...
        <div class="portlet">
            <div class="portlet-header">
                ...
                <a href="#" data-target="#modal-add-user" data-toggle="modal" class="btn btn-success">Add New &nbsp;<i
                ...
                <div class="btn-group">
                    ...
                    <ul role="menu" class="dropdown-menu">
                        <li><a href="#" data-target="#modal-delete-selected" data-toggle="modal" class="deleteid"
                               rel="{{url()}}/admin/page/deletemultipleuserlist" rev="modal-delete-selected">Delete
                ...
                <!--Modal Add New start-->
                <div id="modal-add-user" tabindex="-1" role="dialog" aria-labelledby="modal-login-label"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Role <span
                                                class='require'>*</span></label>
                                        <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        <label for="password" class="control-label col-md-3">Confirm Password <span
                                                class='require'>*</span></label>
                                        <div class="col-md-6">
                                            <div class="input-icon"><i class="fa fa-key"></i>
                                                {{Form::password('confirmpassword', array('id'=>'confirmpassword','class' => 'validate[required] form-control'))}}
                                                <span class="text-10px">(Password length should be between 6-12 characters)</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 margin-top-5px">
                                            <div class="text-blue border-bottom">You can select multiple pages from
                                                the below section.
                                            </div>
                                            <div class="checkbox-list margin-top-10px">
                                                <label class="checkbox-inline"><input name="access[]"
                                                                                      id="inlineCheckbox1"
                                                ...
                                                <label class="checkbox-inline"><input name="access[]"
                                                                                      id="inlineCheckbox3"
                                                                                      type="checkbox"
                                                                                      value="career"/>&nbsp; Careers</label>
                                                <label class="checkbox-inline"><input name="access[]"
                                                                                      id="inlineCheckbox33"
                                                                                      type="checkbox" value="comppro"/>&nbsp;
                                                    Company Profile</label>
                                                <label class="checkbox-inline"><input name="access[]"
                                                                                      id="inlineCheckbox34"
                                                                                      type="checkbox" value="cusex"/>&nbsp;
                                                    Customer Experience</label>
                                                <label class="checkbox-inline"><input name="access[]"
                                                                                      id="inlineCheckbox35"
                                                                                      type="checkbox" value="quass"/>&nbsp;
                                            ...
                                            <div class="margin-top-10px"><strong>Services:</strong></div>
                                            ...
                                            <div class="margin-top-10px"><strong>Industries:</strong></div>
                                            <div class="checkbox-list">
                                                <label class="checkbox-inline"><input name="access[]"
                                                                                      id="inlineCheckbox1"
                                                                                      type="checkbox"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-actions">
                                    <div class="col-md-offset-4 col-md-8"><a href="#" class="btn btn-red">Yes &nbsp;<i
                ...
                <div id="modal-delete-all" tabindex="-1" role="dialog" aria-labelledby="modal-login-label"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-actions">
                                    <div class="col-md-offset-4 col-md-8"> {{ Form::open(array('url' => 'admin/deleteallusers', 'method' => 'post', 'name' => 'deleteallpressrelease', 'id' => 'deleteallpressrelease', 'class' => 'form-horizontal','files' => true)) }}
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tr>
                        ...
                        <td><a href="#" data-hover="tooltip" data-placement="top"
                               data-target="#modal-edit-user{{ $user->id }}" data-toggle="modal"
                               title="Edit"><span class="label label-sm label-success"><i
                            ...
                            <div id="modal-edit-user{{ $user->id }}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-body">
                                            <div class="form">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="input-icon"><i class="fa fa-key"></i>
                                                            {{Form::password('password', array('id'=>"password$user->id", 'class' => 'validate[required,minSize[6],maxSize[12]] form-control'))}}
                                                            <span class="text-10px">(Password length should be between 6-12 characters)</span>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="password" class="control-label col-md-3">Confirm
                                                        Password <span class='require'>*</span></label>
                                                    <div class="col-md-6">
                                                        <div class="input-icon"><i class="fa fa-key"></i>
                                                            {{Form::password("confirmpassword$user->id", array('id'=>'confirmpassword','class' => "validate[required,equals[password$user->id]] form-control"))}}
                                                            <span class="text-10px">(Password length should be between 6-12 characters)</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <?php
                                                        ...
                                                        $checked1 = ''; $checked2 = ''; $checked3 = ''; $checked4 = ''; $checked5 = ''; $checked6 = ''; $checked7 = ''; $checked8 = ''; $checked9 = ''; $checked10 = ''; $checked11 = ''; $checked12 = '';
                                                        $checked13 = ''; $checked14 = ''; $checked15 = ''; $checked16 = '';$checked33 = '';$checked34 = '';$checked35 = '';
                                                        if (is_array($data) && !empty($data)) {
                                                            ...
                                                            if (in_array('whatwedo', $data)) {
                                                                $checked5 = "checked='checked'";
                                                            } else {
                                                                $checked5 = "";
                                                            }

                                                            if (in_array('technology', $data)) {
                                                                $checked6 = "checked='checked'";
                                                            } else {
                                                                $checked6 = "";
                                                            }

                                                            if (in_array('industries', $data)) {
                                                          ...
                                                          //  if (in_array('pkcanpac', $data)) {
                                                            ...
                                                            if (in_array('boardcharter', $data)) {
                                                                $checked16 = "checked='checked'";
                                                            } else {
                                                                $checked16 = "";
                                                            }
                                                            if (in_array('comppro', $data)) {
                                                                $checked33 = "checked='checked'";
                                                            } else {
                                                                $checked33 = "";
                                                            }
                                                            if (in_array('cusex', $data)) {
                                                                $checked34 = "checked='checked'";
                                                            } else {
                                                                $checked34 = "";
                                                            }
                                                            if (in_array('quass', $data)) {
                                                                $checked35 = "checked='checked'";
                                                            } else {
                                                                $checked35 = "";
                                                            }
                                                        }
                                                        ?>
                                                <label class="control-label col-md-3">Permission &amp; Edit
                                                    Pages</label>
                                                <div class="col-md-9 margin-top-5px">
                                                    <div class="text-blue border-bottom">You can select multiple
                                                        pages from the below section.
                                                    </div>
                                                    <div class="checkbox-list margin-top-10px">
                                                        <label class="checkbox-inline"><input name="access[]"
                                                                                              id="inlineCheckbox1"
                                                        ...
                                                        <label class="checkbox-inline"><input name="access[]"
                                                                                              id="inlineCheckbox2"
                                                                                              type="checkbox"
                                                                                              value="index" {{ $checked2 }}/>&nbsp;
                                                            Index</label>
                                                        <label class="checkbox-inline"><input name="access[]"
                                                                                              id="inlineCheckbox3"
                                                                                              type="checkbox"
                                                                                              value="career" {{ $checked3 }}/>&nbsp;
                                                            Careers</label>
                                                        <label class="checkbox-inline"><input name="access[]"
                                                                                              id="inlineCheckbox33"                                                                                                 type="checkbox"
                                                                                              value="comppro"
                                                                                              {{ $checked33 }}
                                                            />&nbsp;
                                                            Company Profile</label>
                                                        <label class="checkbox-inline"><input name="access[]"
                                                                                              id="inlineCheckbox34"
                                                                                              type="checkbox" value="cusex"{{ $checked34 }}/>&nbsp;
                                                            Customer Experience</label>
                                                        <label class="checkbox-inline"><input name="access[]"
                                                                                              id="inlineCheckbox35"
                                                                                              type="checkbox" value="quass"{{ $checked35 }}/>&nbsp;
                                                            Quality Assurance</label>
                                                        <label class="checkbox-inline"><input name="access[]"
                                                                                              id="inlineCheckbox3"
                                                                                              type="checkbox"
                                                                                              value="contact" {{ $checked4 }}/>&nbsp;
                                                            Contact Us</label>
                                                    ...
                                                    <div class="checkbox-list">
                                                        <label class="checkbox-inline"><input name="access[]"
                                                                                              id="inlineCheckbox1"
                                                                                              type="checkbox"
                                                                                              value="whatwedo" {{ $checked5 }}/>&nbsp;
                                                            What We Do</label>
                                                        <label class="checkbox-inline"><input name="access[]"
                                                                                              id="inlineCheckbox2"
                                                                                              type="checkbox"
                                                                                              value="technology" {{ $checked6 }}/>&nbsp;
                                                            Technology</label>
                                                    </div>

                                                    <div class="margin-top-10px"><strong>Industries:</strong>
                                                    </div>
                                                    <div class="checkbox-list">
                                                        <label class="checkbox-inline"><input name="access[]"
                                                                                              id="inlineCheckbox1"
                                                                                              type="checkbox"
                                                                                              value="industries" {{ $checked7 }}/>&nbsp;
                                                            Industries</label>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <!--END MODAL Add New-->
            <!--Modal delete start-->
            <div id="modal-delete-user{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-login-label"
                 aria-hidden="true" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-actions">
                                <div class="col-md-offset-4 col-md-8"> {{ Form::open(array('url' => 'admin/deletesingleuser', 'method' => 'post', 'name' => 'deletepressrelease'.$user->id, 'id' => 'deletepressrelease'.$user->id, 'class' => 'form-horizontal','files' => true)) }}{{ Form::hidden('userid',$user->id) }}
                                    <button type="submit" class="btn btn-red">Yes &nbsp;<i class="fa fa-check"></i>
                                    </button>&nbsp; <a href="#" data-dismiss="modal" class="btn btn-green">No &nbsp;<i
            ...
            <div class="tool-footer text-right">
                <p class="pull-left">Showing {{ $users->getFrom() }} to {{ $users->getTo() }}
                    of {{ $users->getTotal() }} entries</p>
                {{ $users->links() }}
            </div>
            <div class="clearfix"></div>
        </div>
