	...
	*/
	...
	public function showWelcome()
	{
        ...
        public function showIndex()
        {
            ...
            $about_cpi = DB::table('settings')->get();
            // dd($about_cpi);
            return View::make('front.frontindex',array('page' => $page[0],'banners' => $banners,'front' => '1','corebusinesses'=>$corebusinesses, 'about_cpi' => $about_cpi));
        }
...
//echo '<pre>'; print_r($companyProfile); die;
        	return View::make('front.profile', array('companyProfile' => $companyProfile, 'sliderImages'=>$sliderImages, 'about_cpi' => $about_cpi));
        }
...
//echo '<pre>'; print_r($data); die;
        	return View::make('front.info', array('data'=> $data, 'about_cpi' => $about_cpi));
        }
		...
		public function showHealthPolicy()
        {
            $data = OshPolicy::first();;
            // $data = DB::table('salim')->where('id', 1)->first();
            dd($data);
        	return View::make('front.policy', array('data'=> $data));

        	// return View::make('front.healthpolicy');
        }
		
		public function showQualityPolicy()
        {
            $data = QualityPolicy::first();
        	return View::make('front.policy', array('data'=> $data));

        	// return View::make('front.qualitypolicy');
        }
		
		public function showEnvironmentalPolicy()
        {
            $data = EnvironmentalPolicy::first();
        	return View::make('front.policy', array('data'=> $data));

        	// return View::make('front.environmentalpolicy');
        }
		
		public function showCommandment()
        {
            $data = Commandment::first();
        	return View::make('front.policy', array('data'=> $data));

        	// return View::make('front.commandment');
        }
        ...
        public function showPaperBags()
        {
            ...
            $about_cpi = DB::table('settings')->get();
        	return View::make('front.paper', array('page' => $page[0], 'about_cpi' => $about_cpi));
        }
        ...
        public function showCartoon()
        {
            ...
            $about_cpi = DB::table('settings')->get();
        	return View::make('front.cartoon', array('page' => $page[0], 'sliderImages'=>$sliderImages, 'about_cpi' => $about_cpi));
        }
        ...
        public function showNomination()
        {
            ...
            $about_cpi = DB::table('settings')->get();
        	return View::make('front.nomination', array('page' => $page[0], 'about_cpi' => $about_cpi));
        }
