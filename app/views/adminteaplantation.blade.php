            ...
            <!--Modal Edit Google Map start-->
              ...
              <div class="portlet">
                <div class="portlet-header">
                  ...
                  note to programmer: if no banner image is uploaded in this section, plesae hide the entire banner image section in front end and move the text section up. <a href="#" data-target="#modal-add-new-banner" data-toggle="modal" class="btn btn-success">Add New Banner &nbsp;<i class="fa fa-plus"></i></a>&nbsp;
                  <div class="btn-group">
