        ...
        <nav id="topbar" role="navigation" style="margin-bottom: 0;" class="navbar navbar-default navbar-static-top">
          ...
          {{ HTML::image('assets/admin/images/logo_web88.png','web88') }}
              ...
              <div class="topbar-main">
                  <a id="logo" href="http://www.kym.com.my" class="navbar-brand" target="_blank">
...
Feedback - Listing</li>';
               ...
               $bread = '<li><i class="fa fa-home"></i>&nbsp;<a href="'.url().'/admin/dashboard">Dashboard</a>&nbsp; <i class="fa fa-angle-right"></i>&nbsp;</li><li>Business &nbsp; <i class="fa fa-angle-right"></i>&nbsp;</li><li class="active">

Multiwall Industrial Paper Bags - Edit</li>';
               $title = "Business";
...
Corrugated Carton Boxes - Edit</li>';
               $title = "Business";
...
Terms of Reference of Nomination and Remuneration Committee - Edit</li>';
               $title = "Investor Relations";
