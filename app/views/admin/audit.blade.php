...
<div class="row">
            <div class="col-lg-12">
              <h2>Terms of Reference of Audit Committee <i class="fa fa-angle-right"></i> Edit</h2>
