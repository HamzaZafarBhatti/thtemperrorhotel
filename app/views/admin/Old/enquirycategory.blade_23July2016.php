...
<div class="row">
    <div class="col-lg-12">
        ...
        <ul id="myTab" class="nav nav-tabs">
            <li class="active"><a href="#main-category" data-toggle="tab">Main Category Setup</a></li>
            <li><a href="#sub-category" data-toggle="tab">Sub Category Setup</a></li>
        </ul>
...
//                                    die("here");
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$sub_category->parent_category->title}}</td>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="col-md-3 control-label">Enquiry Related to <br/> (Main Category)<span class='require'>*</span></label>
                                                                    <div class="col-md-6">
                                                                         {{Form::select('parent_id', $categories_arr,$sub_category->parent_category->id,['id'=>'parent_id','class'=>"validate[required] form-control"])}}
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="col-md-3 control-label">Sub Category <span class='require'>*</span></label>
