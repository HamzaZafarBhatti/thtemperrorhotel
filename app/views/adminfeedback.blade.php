                      ...
                      <div class="grid_12">
                        ...
                        <div class="map-wrapper">
                          <div class="map-canvas">
                            <iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBucdmYTVx1XYzjNAd9QN2l5LgxqYG9rWk
    &q={{ $page[0]->right_block1_content }}" width="100%" height="350" frameborder="0" style="border:0" allowfullscreen></iframe>
                          </div>
                        </div>
...
<div class="grid_3">
              ...
              <div id="modal-edit-map" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                <div class="modal-dialog modal-wide-width">
                  ...
                  <iframe id="map_load_dynamic1" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBucdmYTVx1XYzjNAd9QN2l5LgxqYG9rWk&q={{ $page[0]->right_block1_content }}"
