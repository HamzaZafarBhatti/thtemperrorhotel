...
<div class="row">
            <div class="col-lg-12">
              <h2>Technology <i class="fa fa-angle-right"></i> Edit</h2>
                        ...
                        <div class="modal-body">
                            <div class="form">
                                ...
                                <div class="form-actions">
                                    {{ Form::hidden('type','technology',array('id' => 'type')) }}
