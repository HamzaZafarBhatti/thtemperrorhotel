...
class ContactController extends BaseController {
   ...
   width="100%" height="230" frameborder="0" style="border:0;"></iframe>';
    ...
    public function submitFeedback() {
        ...
        $enquiry_email = Enquiryemail::where($matchThese)->first();
        if (!empty($enquiry_email)) {
            $email_id = $enquiry_email->email;
            ...
            Mail::send('email', $emailcontent, function($message) use ($email_id) {
                $message->to($email_id, 'Learning Laravel Support')
