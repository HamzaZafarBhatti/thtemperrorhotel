...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="pull-left margin-top-10px"> Last updated:
                <span class="text-blue">
                    {{ date("d F Y",strtotime($page[0]->updated_at)) }} @ {{ date("g:i A",strtotime($page[0]->updated_at)) }}
                </span>
            </div>
            <div class="clearfix"></div>
            <p></p>

            {{ Form::open(array('url' => 'admin/page/savepage','class'=> 'form-horizontal','method' => 'post','name' => 'boardchartersave','id' => 'boardchartersave')) }}
            {{ Form::hidden('preview','')}}
            ...
            <div class="portlet">
                ...
                <div class="form-actions none-bg"><a href="javascript:void(0);" class="btn btn-red"
                                                     onclick="Addsavepage('boardchartersave','investorrelations/boardcharters');">Save
                        &amp; Preview &nbsp;<i class="fa fa-search"></i></a>&nbsp;
                    <button type="submit" class="btn btn-blue">Save &amp; Publish &nbsp;<i class="fa fa-globe"></i>
                    </button>
        ...
        <div class="portlet">
            <div class="portlet-header">
                <div class="caption">Corporate Governance Listing</div>
                <br/>

                <p class="margin-top-10px"></p>
                <a href="#" data-target="#modal-add-new-banner" data-toggle="modal" class="btn btn-success">Add New
                ...
                <div class="btn-group">
                    ...
                    <ul role="menu" class="dropdown-menu">
                        <li><a href="#" data-target="#modal-delete-selected" data-toggle="modal" class="deleteid"
                               rel="{{url();}}/admin/page/deletemultipleboard" rev="modal-delete-selected">Delete
                ...
                <div id="modal-add-new-banner" tabindex="-1" role="dialog" aria-labelledby="modal-login-label"
                    ...
                    <div class="modal-dialog modal-wide-width">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 id="modal-login-label3" class="modal-title">Add New PDF</h4>
                            </div>
                            <div class="modal-body">
                                <div class="form">
                                    {{ Form::open(array('url' => 'admin/board/addcharters', 'method' => 'post', 'class' => 'form-horizontal','files' => true)) }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            {{Form::textarea('short_description', '',array('id'=>'short_description','class' => 'form-control','rows' => '2'))}}
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Upload Report<br/> Cover <span
                                                    class='require'>*</span></label>
                                        ...
                                        <div class="col-md-8">
                                            <div class="text-15px margin-top-10px">
                                                ...
                                                <br/>
                                                <span class="help-block">(Image dimension: 200 x 248 pixels, JPEG/GIF/PNG only, Max. 2MB) </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="modal-body">
                                <div class="form-actions">
                                    <div class="col-md-offset-4 col-md-8"><a href="#" class="btn btn-red">Yes &nbsp;<i
                                                    class="fa fa-check"></i></a>&nbsp; <a href="#" data-dismiss="modal"
                ...
                <div id="modal-delete-all" tabindex="-1" role="dialog" aria-labelledby="modal-login-label"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-actions">
                                    <div class="col-md-offset-4 col-md-8"> {{ Form::open(array('url' => 'admin/board/deleteallcharters', 'method' => 'post', 'name' => 'deleteallsementra', 'id' => 'deleteallsementra', 'class' => 'form-horizontal','files' => true)) }}
            ...
            <div class="portlet-body">
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                    @foreach($boardcharters as $k => $sementrasbanner)
                        <tr>
                            ...
                            <td><a href="{{ url().$sementrasbanner->pdf->url() }}">{{$sementrasbanner->title}}</a></td>
                            <td><a href="#" data-hover="tooltip" data-placement="top"
                                   data-target="#modal-edit-slidingbanner{{$sementrasbanner->id}}" data-toggle="modal"
                                ...
                                <a href="#" data-hover="tooltip" data-placement="top" title="Delete"
                                   data-target="#modal-delete-slide{{$sementrasbanner->id}}" data-toggle="modal"><span
                                            class="label label-sm label-red"><i class="fa fa-trash-o"></i></span></a>
                                <!--Modal Edit Banner start-->
                                <div id="modal-edit-slidingbanner{{$sementrasbanner->id}}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-wide-width">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" data-dismiss="modal" aria-hidden="true"
                                                        class="close">&times;</button>
                                                <h4 id="modal-login-label3" class="modal-title">Edit PDF</h4>
                                          </div>
                                            <div class="modal-body">
                                                <div class="form">
                                                    {{ Form::open(array('url' => 'admin/board/editcharters', 'method' => 'post', 'class' => 'form-horizontal','files' => true)) }}
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label">Status</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label">Short Discription <span
                                                                    class='require'>*</span></label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label">Upload Report Cover <span
                                                                    class='require'>*</span></label>

                                                        <div class="col-md-8">
                                                            <div class="text-15px margin-top-10px"> {{HTML::image($sementrasbanner->image->url('thumb'),'image',array( 'class' => 'img-responsive' ));}}
                                                                <br/>
                                                                {{Form::file('image', null,array('id'=>'imageInput'))}}
                                                                <br/>
                                                                <span class="help-block">(Image dimension: 200 x 248 pixels, JPEG/GIF/PNG only, Max. 2MB) </span>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label">Upload PDF <span
                                                                    class='require'>*</span></label>
                                ...
                                <!--Modal delete start-->
                                <div id="modal-delete-slide{{$sementrasbanner->id}}" tabindex="-1" role="dialog"
                                     aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 id="modal-login-label4" class="modal-title"><a href=""><i
                                                    ...
                                                    you want to delete this item? </h4>
                                            </div>
                                            <div class="modal-body">
                                                <p><strong>#{{$sementrasbanner->id}}
                                                        :</strong> {{$sementrasbanner->title}}</p>

                                                <div class="form-actions">
                                                    <div class="col-md-offset-4 col-md-8">  {{ Form::open(array('url' => 'admin/board/deletecharters', 'method' => 'post', 'name' => 'sementrasbanner'.$sementrasbanner->id, 'id' => 'sementrasbanner'.$sementrasbanner->id, 'class' => 'form-horizontal','files' => true)) }}{{ Form::hidden('sementrasbannerid',$sementrasbanner->id) }}
                ...
                <div class="tool-footer text-right">
                    <p class="pull-left">Showing {{ $boardcharters->getFrom() }} to {{ $boardcharters->getTo() }}
                        of {{ $boardcharters->getTotal() }} entries</p>
                    {{ $boardcharters->links() }}
                </div>
                <div class="clearfix"></div>
            </div>
