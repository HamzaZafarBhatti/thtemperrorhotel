...
<div class="row">
    ...
    <div class="col-lg-12">
        <h2>Commandment <i class="fa fa-angle-right"></i> Edit</h2>
        ...
        <div class="clearfix"></div>
        <p></p>
        {{ Form::open(array('url' => 'admin/upadteCommandment','class'=> 'form-horizontal','method' => 'post','name' => 'announcementsave','id' => 'announcementsave', 'enctype' =>"multipart/form-data")) }} 
{{Form::hidden('preview','')}}
        <div class="portlet">
            ...
            <div class="modal-dialog modal-wide-width">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="form">
  {{ Form::open(array('url' => 'admin/commandment/editImage', 'method' => 'post', 'name' => 'editImage', 'id'=>'imageEdit', 'class' => 'form-horizontal','files' => true)) }}      
  {{ Form::hidden('pagename',"commandment") }}
                ...
                {{Form::checkbox('active', 1,$data->bodyImages_active==1?true:false,array('id'=>'active','class' => 'form-control'))}}
                    ...
                    <!--END MODAL Edit body image-->
                        ...
                        <div id="modal-delete-backgroundImage" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="true" class="modal fade">
                          {{ Form::open(array('url' => 'admin/commandment/deleteImage', 'method' => 'post', 'name' => 'deleteImage', 'id'=>'imageDelete', 'class' => 'form-horizontal')) }}      
                          {{ Form::hidden('pagename',"commandment") }}
                          {{ Form::hidden('type',"background") }}
