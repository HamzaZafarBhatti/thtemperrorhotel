...
@section('content')
<!-- Slider -->
  {{ HTML::image('assets/front/images/banner_subpage/banner6.jpg','banner-subpage') }}
<!-- #camera_wrap -->
<!-- Slider / End -->
            ...
            <div class="grid_12">
                ...
                <div class="map-wrapper">
                    <div class="map-canvas">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7954.236663888351!2d101.08476449999999!3d4.5727557!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x304abf8dda235e13%3A0x51a9ab3ab181a026!2sCPI+(Penang)+Sdn.+Bhd.!5e0!3m2!1sen!2smy!4v1540539329003{{ $page->right_block1_content }}" width="100%" height="350" frameborder="0" style="border:0" allowfullscreen></iframe>
                    </div>
                </div>
                ...
                <div class="clearfix">
                    <div class="grid_3 alpha">
                        <div class="field">
                            ...
                            {{ Form::text('name','',array('id' => 'name','class' => 'validate[required,custom[onlyLetterSp]]'))}}
                        </div>
                    </div>
                    <div class="grid_3">
                        <div class="field">
                    ...
                    <div class="grid_3 omega">
                        <div class="field">
                            ...
                            {{ Form::text('contact_number','',array('id' => 'contact_number','class' => 'validate[required,custom[phone]]'))}}
                        </div>
                    </div>
                    ...
                    <div class="grid_3 alpha">
                        <div class="field">
                            ...
                            {{ Form::text('company_name','',array('id' => 'company_name','class' => 'validate[required,custom[onlyLetterNumberSp]]'))}}
                        </div>
                    </div>
                    <div class="grid_3">
                        <div class="field">
                            <label for="contact-message"><strong>Company Address</strong> </label>
                            {{ Form::text('company_address','',array('id' => 'company_address','class' => 'validate[required,custom[onlyLetterNumberSp]]'))}}
                        </div>
                    </div>
                    <div class="grid_3 omega">
                        <div class="field">
                    ...
                    <div class="grid_3">
                        <div class="field">
                            ...
                            {{ Form::text('post_code','',array('id' => 'post_code','class' => 'validate[custom[onlyLetterNumberSp]]'))}}
                        </div>
                    </div>
                    <div class="grid_3 omega">
                        <div class="field">
                ...
                <div class="clearfix">
                    <div class="grid_9 alpha omega">
                        <div class="field">
                            ...
                            {{ Form::text('subject','',array('id' => 'subject','class' => 'validate[required,custom[onlyLetterNumberSp]]'))}}
                        </div>
                    </div>
                </div>
                ...
                <div class="clearfix">
                    <div class="grid_9 alpha omega">
                        <div class="field">
							...
							<div class="g-recaptcha" data-sitekey="6LeG9XcUAAAAANjuGpjWKkxvOQrCHKGz6cS5xax6"></div>
                        </div>
                    </div>
                </div>
