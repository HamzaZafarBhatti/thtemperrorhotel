...
<div class="row">
            <div class="col-lg-12">
              <h2>Terms of Reference of Nomination and Remuneration Committee <i class="fa fa-angle-right"></i> Edit</h2>
           ...
           {{Form::hidden('type',$page->type)}}
              <div class="portlet">
                ...
                <div class="portlet-body">
                  <div contenteditable="true" id="right-block3-content" style="padding-bottom:36px">
