...
class Career1Controller extends BaseController {
    ...
    public function vaccancyIndex() {
        ...
        $vaccancies = Career::orderBy('updated_at', 'DESC')->paginate($noperpage);

        return View::make('admin.vaccancies', array(
                    'page' => $page,
    ...
    public function applicantsListing() {
        ...
        $pgCount = Application::leftJoin('vaccancies', 'applications.vaccancyid', '=', 'vaccancies.id')->count();
        ...
        $applicants = Application::select('applications.*', 'vaccancies.job_location', 'vaccancies.job_title', 'vaccancies.post_date', 'vaccancies.company')->leftjoin('vaccancies', 'applications.vaccancyid', '=', 'vaccancies.id')->orderBy('updated_at', 'DESC')->paginate($noperpage);
        //dd(count($cntarray1));
    ...
    public function frontCareer() {
        ...
        return View::make('front.carrer', array(
                    'masthead' => $masthead,
    ...
    public function showApplyForm($vaccancy_id) {
        ...
        $page = Page::where('type', '=', 'application')->where('published', '=', 1)->get();
        $masthead = url() . '/images/banner_subpage/banner10.jpg';
        ...
        $mainMenuTitle = $page[0]->page_title;
        return View::make('front.frontapplyform', array(
                    'vaccancy' => $vaccancy,
                    'page' => $page[0],
                    'mainMenuTitle' => $mainMenuTitle,
                    'masthead' => $masthead,
