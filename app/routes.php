...
//Front end routes starts
	...
	Route::get('/company/customerexperience','HomeController@showInfo');
	Route::get('/company/qualityassurance','HomeController@showVision');
	Route::get('/company/boardofdirectors','HomeController@showBoard');
	Route::get('/company/structure','HomeController@showStructure');
	Route::get('/company/healthpolicy','HomeController@showHealthPolicy');
	Route::get('/company/qualitypolicy','HomeController@showQualityPolicy');
	Route::get('/company/environmentalpolicy','HomeController@showEnvironmentalPolicy');
	Route::get('/company/commandment','HomeController@showCommandment');

	Route::get('/company/whatwedo','HomeController@showPaperBags');
	Route::get('/company/technology','HomeController@showCartoon');
	Route::get('/company/boardcharter','HomeController@showBoardCharter');
	Route::get('/company/auditcommitte','HomeController@showAudit');
	Route::get('/company/industries','HomeController@showNomination');
	//Route::get('/company/financial','HomeController@showFinance');
	Route::get('/company/announcements','HomeController@showAnnouncement');
	//Route::get('/careers','HomeController@showCarrer');

	Route::get('/careers', 'Career1Controller@frontCareer');
	...
	//Route::get('contacts/feedback/submitfeedback', 'ContactController@submitFeedback');
...
{
  Route::get('admin/footer_setup', 'SettingsController@footer_setup');
  Route::post('admin/edit_footer_setup/add', 'SettingsController@edit_footer_setup');
  Route::post('admin/edit_footer_setup/edit', 'SettingsController@edit_footer_setup');
  Route::post('admin/edit_footer_setup', 'SettingsController@edit_footer_setup');
	// dashboard admin
	...
	Route::post('admin/applicants/deleteapplication', 'Career1Controller@deleteApplication');
        ...
        //company experiences
        Route::get('admin/customer-experiences', 'AdminController@companyExperiences');
        Route::post('admin/upadteCompanyExperiences', 'AdminController@upadteCompanyExperiences');

        //company profile
        Route::get('admin/company-profile', 'AdminController@companyProfile');
        Route::post('admin/upadteCompanyProfile', 'AdminController@upadteCompanyProfile');
        
        //slider images
        //Route::get('admin/delete-slider-image/{id}', 'AdminController@deleteSliderImage');

        //quality assurance
        Route::get('admin/quality-assurance', 'AdminController@qualityAssurance');
        Route::post('admin/upadteQualityAssurance', 'AdminController@upadteQualityAssurance');

        Route::get('admin/oshpolicy', 'AdminController@oshpolicy');
        Route::post('admin/upadteOshPolicy', 'AdminController@upadteOshPolicy');

        Route::get('admin/qualitypolicy', 'AdminController@qualitypolicy');
        Route::post('admin/upadteQualityPolicy', 'AdminController@upadteQualityPolicy');

        Route::get('admin/environmentalpolicy', 'AdminController@environmentalpolicy');
        Route::post('admin/upadteEnvironmentalpolicy', 'AdminController@upadteEnvironmentalpolicy');
        
        Route::get('admin/commandment', 'AdminController@commandment');
        Route::post('admin/upadteCommandment', 'AdminController@upadteCommandment');
	...
	Route::get('admin/business/whatwedo', 'BusinessController@adminPaperBags');
        Route::get('admin/business/technology', 'BusinessController@adminCorrugated');
	...
	Route::get('admin/governance/industries', 'GovernanceController@adminNomination');
...
Route::post('admin/change_order', 'AdminController@changeOrder');
...
Route::post('admin/page/deleteallbanner', 'PageController@adminDeleteAllBanner');
