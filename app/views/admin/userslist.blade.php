...
@section('content')
    <div class="row">
        <div class="col-lg-12">
           ...
           <label class="checkbox-inline"><input name="access[]"
                                                                                          id="inlineCheckbox10"
                                                                                          type="checkbox"
                                                                                          value="pmoil"/>&nbsp; Company Profile</label>
           <label class="checkbox-inline"><input name="access[]"
                                                                                          id="inlineCheckbox3"
                                                                                          type="checkbox"
                                                    ...
                                                    <label class="checkbox-inline"><input name="access[]"
                                                                                          id="inlineCheckbox9"
                                                                                          type="checkbox"
                                                                                          value="pksoutheast"/>&nbsp; Customer Experience</label>
           <label class="checkbox-inline"><input name="access[]"                                                                                       
                                                                       id="inlineCheckbox8"
                                                                                        type="checkbox"
                                                                                          value="pkcanpac"/>&nbsp; Quality Assurance</label>
                                                    <label class="checkbox-inline"><input name="access[]"
                                                                                          id="inlineCheckbox3"
                                                                                          type="checkbox"
                                                                                          value="contact"/>&nbsp;
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      $data = unserialize($user->accesslist);
                                                        ...
                                                        $checked1 = ''; $checked2 = ''; $checked3 = ''; $checked4 = ''; $checked5 = ''; $checked6 = ''; $checked7 = ''; $checked8 = ''; $checked9 = ''; $checked10 = ''; $checked11 = ''; $checked12 = '';$checked13 = ''; $checked14 = ''; $checked15 = ''; $checked16 = '';
 ...
 <label class="checkbox-inline"><input name="access[]"
                                                                                                      id="inlineCheckbox10"
                                                                                                      type="checkbox"
                                                                                                      value="pmoil" {{ $checked10 }}/>&nbsp;
                                                                    Company Profile</label>

 <label class="checkbox-inline"><input name="access[]"
                                                                                                      id="inlineCheckbox9"
                                                                                                      type="checkbox"
                                                                                                      value="pksoutheast" {{ $checked9 }}/>&nbsp;
                                                                    Customer Experience</label>

<label class="checkbox-inline"><input name="access[]"
                                                                                                      id="inlineCheckbox8"
                                                                                                      type="checkbox"
                                                                                                      value="pkcanpac" {{ $checked8 }}/>&nbsp;
