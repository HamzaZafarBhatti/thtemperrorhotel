            ...
            <header class="entry-header clearfix">
              <div class="entry-header-inner">
                <div contenteditable="true" id="left-block1-title">
                 ...
                 {{ Form::textarea('left_block1_title',$page[0]->left_block1_title,array("id" => "textarea-left_block1_title","class" => "hideThisField")) }}
                ...
                <div class="portlet-header">
                  ...
                  <div class="btn-group">
                    ...
                    <ul role="menu" class="dropdown-menu">
                      <li><a href="#" data-target="#modal-delete-selectednot" data-toggle="modal"  class="deleteid" rel="{{url();}}/admin/page/deletemultipleapplicants" rev="modal-delete-selected">Delete selected item(s)</a></li>
                      <li class="divider"></li>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                  <label for="inputPostCode" class="col-md-4 control-label">Applicant CV:</label>
                                                                    ...
                                                                    <div class="col-md-8">
                                                                      <p class="form-control-static"><a href="{{ url().'/public'.$applicant->resume->url() }}" target="_blank">use the uploaded cv file name</a></p></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- end CV-->
